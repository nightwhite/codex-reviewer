...
export function buildReviewPrompt(input: ReviewPromptInput): string {
  return [
    ...
    "",
    "- 🎯 **CLEAN** — the pull request matches the PR intent.",
    "- 🎯 **DRIFT DETECTED** — the pull request includes unrelated or surprising changes.",
    "- 🎯 **REQUIREMENTS MISSING** — the pull request appears incomplete for the stated intent.",
    "",
